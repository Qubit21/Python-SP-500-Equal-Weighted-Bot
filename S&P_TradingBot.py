...
def chunks(lst, n):
    """Yield successive n-sized chinks from list."""
...
while True:
    try:
        ...
        print("*** Not a valid integer entered! Please try again ... ***")
print("*** Great! Calculating number of shares to buy now ***")
...
# Applying the format to the coloumns of the .xlsx file
column_formats = {
